...
- AI 코딩 도구 관련 기사라면: 시니어 개발자에게 미치는 영향(생산성 레버리지)과 주니어 개발자에게 미치는 영향(성장 경로 변화)을 구분해 분석하세요
...
- AI 코딩 도구 관련 기사라면: AI 생성 코드에 대한 코드 리뷰 프로세스가 왜 필수인지, 실무에서 어떻게 적용해야 하는지 반드시 언급하세요
- 한국어로 작성, 300자 이내""",
...
- AI 코딩 도구 관련 기사라면: "AI가 코딩을 민주화한다"는 담론이 실제로는 과장일 수 있는 근거를 제시하세요 (예: 복잡도의 이동, 디버깅 부담 증가, 기술 부채 누적 등)
